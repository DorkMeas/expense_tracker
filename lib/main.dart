                    ...
                    child: Column(
                      ...
                      children: [
                        const Icon(Icons.account_balance_wallet_rounded,
                            size: 54, color: Color(0xFF1E5FA3)),
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        ...
        const SizedBox(height: 8),
        const _ExpenseTile(
            title: 'Lunch – Khmer Food',
            subtitle: 'Today, 12:30pm',
            amount: '-\$2.50',
            icon: Icons.restaurant),
        const _ExpenseTile(
            title: 'Taxi',
            subtitle: 'Today, 8:00am',
            amount: '-\$1.50',
        ...
        FilledButton(
          ...
          onPressed: () {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                  content: Text('Saved $amount USD in $_category category')),
            );
          },
    ...
    return ListView(
      ...
      children: [
        ...
        const _BreakdownItem(
            label: 'Food', percent: '40%', color: Color(0xFF1E5FA3)),
        const _BreakdownItem(
            label: 'Transport', percent: '25%', color: Color(0xFFFFC107)),
        const _BreakdownItem(
            label: 'Study', percent: '18%', color: Color(0xFF4CAF50)),
        const _BreakdownItem(
            label: 'Other', percent: '17%', color: Color(0xFFBDBDBD)),
        const SizedBox(height: 16),
        Container(
          ...
          child: const Text(
              '💡 You saved 38% vs last week! Keep it up — you are on track.'),
        ),
      ],
    );
  }
    ...
    return Container(
      ...
      child: Text(label,
          style: const TextStyle(
              color: Color(0xFF1E5FA3), fontWeight: FontWeight.w600)),
    );
  }
}
